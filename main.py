...
state_merging.compare_learning(alphabet, pos_samples, neg_samples, state_merging_algorithm_dfa=state_merging.merge_with_rpni_order, consistency_type_dfa='type_2', state_merging_algorithm_monoid=state_merging.merge_with_rpni_order, consistency_type_monoid='type_2', name=automaton_1.name)
...
# type_2: negative samples checked after each merge, sink does not need to be covered
...
state_merging.compare_learning(alphabet, pos_samples_dfa, neg_samples_dfa, state_merging.merge_with_rpni_order, 'type_2', state_merging.merge_with_rpni_order, 'type_2', automaton_2.name + '_type2_dfasamples')
...
# type_1: negative samples become rejecting states in the PTA, sink must be covered
...
state_merging.compare_learning(alphabet, pos_samples_dfa, neg_samples_dfa, state_merging.merge_with_rpni_order, 'type_1', state_merging.merge_with_rpni_order, 'type_1', automaton_2.name + '_type1_dfasamples')
...
# samples without sink do not suffice for type_1

pos_samples, neg_samples = state_merging.compute_rpni_complete_samples_for_dfa(automaton_2, cover_sink=False)
state_merging.learn_dfa(alphabet, pos_samples, neg_samples, state_merging.merge_with_rpni_order, 'type_1', name=automaton_2.name + '_consistency_type1')
...
state_merging.rpni_sample_transfer_from_dfa_to_monoid(alphabet, automaton_3, consistency_type='type_2', name=automaton_3.name)
...
#state_merging.learn_dfa(alphabet, pos_samples, neg_samples, state_merging.merge_with_random_order, 'type_2', name=ex_automaton.name + '_random_v1')
#state_merging.learn_dfa(alphabet, pos_samples, neg_samples, state_merging.merge_with_random_order, 'type_2', name=ex_automaton.name + '_random_v2')
#state_merging.learn_dfa(alphabet, pos_samples, neg_samples, state_merging.merge_with_random_order, 'type_2', name=ex_automaton.name + '_random_v3')
